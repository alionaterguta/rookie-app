let pokemonRepository = (function () {
  ...
  function a(t) {
    e.map((t) => t.name).forEach((e) => {
      let n = document.querySelector(`[id=${e}]`);
      n &&
        (e.match(t.toLowerCase())
          ? (n.style.display = "")
    ...
    $("#exampleModal").on("show.bs.modal", function (t) {
      !(function t(e) {
        pokemonRepository.loadDetails(e).then(function () {
          let t = document.querySelector("#titleModal");
          ...
          (a.textContent = "Height: " + e.height + "'"), n.appendChild(a);
          let l = document.createElement("span");
          t.classList.add("spanType"), (l.innerText = "Type: ");
          let i = document.createElement("div");
          i.classList.add("type-container", "container", "row"),
            n.appendChild(i),
            i.appendChild(l),
            e.types.forEach((t) => {
              let e = document.createElement("button");
              e.classList.add("btn-lg", "type-content"),
                (e.innerText = t.type.name),
                i.appendChild(e);
            });
        });
      })(e[t.relatedTarget.dataset.id]);
    }),
    $("#searchItem").on("change input", function (t) {
      a($("#searchItem").val());
    }),
    {
      add: n,
      ...
      addListItem: function e(n) {
        let o = document.querySelector(".row"),
        ...
        (l.innerText = n.name),
          ...
          a.appendChild(l),
          l.classList.add("btn", "btn-lg", "btn-block", "list-btn");
      },
      filterByName: a,
      loadList: function t() {
